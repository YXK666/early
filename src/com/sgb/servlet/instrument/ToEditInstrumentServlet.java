 ...
 *
 */
@WebServlet("/toCopyInstrumentServlet.do")
public class ToEditInstrumentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/manage/copyInstrument.jsp").forward(req,resp);
	}
