 ...
 */
@WebServlet("/toCopyApplianceServlet.do")
public class ToCopyApplianceServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/manage/copyAppliance.jsp").forward(req,resp);
	}
